                ...
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    ${{ number_format(\App\Models\invoices::where('value_status', 1)->sum('total'), 1) }}
                                </h4>
                                <p class="mb-0 tx-12 text-white op-7">
                            ...
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-up text-white"></i>
                                <span class="text-white op-7">
                                    {{ round((\App\Models\invoices::where('value_status', 1)->count() / \App\Models\invoices::count()) * 100, 2) }}%</span>
                ...
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    ${{ number_format(\App\Models\invoices::where('value_status', 3)->sum('total'), 3) }}
                                </h4>
                                <p class="mb-0 tx-12 text-white op-7">
                            ...
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-down text-white"></i>
                                <span class="text-white op-7">
                                    {{ round((\App\Models\invoices::where('value_status', 3)->count() / \App\Models\invoices::count()) * 100, 2) }}%</span>
                            </span>
                            </span>
                        </div>
                    </div>
