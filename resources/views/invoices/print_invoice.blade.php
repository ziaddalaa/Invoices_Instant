										...
										<table class="table table-invoice border text-md-nowrap mb-0">
											...
											<tbody>
												<tr>
													...
													<td class="tx-right">{{number_format($invoice->amount_collection,2)}}</td>
                                                    @php
...
<script type="text/javascript">
    function printDiv()
    {
        var printContent = document.getElementById('print').innetHTML;
        var originalContent = document.body.innetHTML;
        document.body.innetHTML = printContent;
        window.print();
        document.body.innetHTML = originalContent;
        location.reload();
    }
</script>
@endsection